...
public class SuzukisanApplication {
    ...
    public CommandLineRunner addGenre(GenreRepository repository) {
        return (args) -> {
            // save a couple of User
            repository.save(new Genre("MentorGenreTest1"));
            repository.save(new Genre("MentorGenreTest2"));
            repository.save(new Genre("MentorGenreTest3"));
            repository.save(new Genre("MentorGenreTest4"));
            repository.save(new Genre("MentorGenreTest5"));
            repository.save(new Genre("MentorGenreTest6"));
